...
> Chosen candidate queue closed 2026-08-05: 2 shipped (#0046 null-forgiving-lies,
> #0047 the-smuggled-null), 2 rejected (the-oblivious-boundary "too specific";
> the-stale-narrowing built as #0048 then rejected "банально"; see `rejected.md`).
> One Seed remains below.
