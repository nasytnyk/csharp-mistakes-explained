...
> **62** exhibits in **25** halls, latest - **#0062**.
...
- [0062](src/http/0062-timeout-looks-like-cancellation/) never read `OperationCanceledException` as a user cancel - an HttpClient **timeout** is the same type; check `InnerException`
